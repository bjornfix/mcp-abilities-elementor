...
Version 2.3.25 adds native tabbed post sections built from Elementor Nested Tabs plus Posts widgets. Version 2.3.24 clears Cache Enabler page cache through public hooks when Elementor writes or `elementor/clear-cache` invalidate a post or site.
